...
# impute_mice_polyreg <- function(missdf, m = 1, threshold=0.999995, ...) 
#   eval_mice_call(missdf = missdf, method = "polyreg", m = m, threshold=threshold, ...)
# 
# impute_mice_lda <- function(missdf, m = 1, threshold=0.999995, ...) 
#   eval_mice_call(missdf = missdf, method = "lda", m = m, threshold=threshold, ...)

impute_mice_pmm <- function(missdf, m = 1, threshold=0.999995, ...)
  eval_mice_call(missdf = missdf, method = "pmm", m = m, threshold=threshold, ...)

impute_mice_cart <- function(missdf, m = 1, threshold=0.999995, ...)
  eval_mice_call(missdf = missdf, method = "cart", m = m, threshold=threshold, ...)

impute_mice_rf <- function(missdf, m = 1, threshold=0.999995, ...)
  eval_mice_call(missdf = missdf, method = "rf", m = m, threshold=threshold, ...)

impute_mice_default <- function(missdf, m = 1, threshold=0.999995, ...) 
  eval_mice_call(missdf = missdf, method = NULL, m = m, threshold=threshold, ...)

impute_mice_cart50 <- function(missdf, m = 1, threshold=0.999995, ...)
  impute_mice_cart(missdf, m = 1, maxit = 50, threshold = threshold, ...)

impute_mice_cart100 <- function(missdf, m = 1, threshold=0.999995, ...)
